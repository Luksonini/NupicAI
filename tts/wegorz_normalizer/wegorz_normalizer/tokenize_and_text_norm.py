...
try:
    from .inflect_pl import cardinal_inflect as _cardinal_inflect
    from .inflect_pl import ordinal_inflect as _ordinal_inflect
    from .inflect_pl import hour_ordinal as _hour_ordinal
    from .unit_registry import REGISTRY as _REGISTRY
except ImportError:
    try:
        from wegorz_normalizer.inflect_pl import cardinal_inflect as _cardinal_inflect
        from wegorz_normalizer.inflect_pl import ordinal_inflect as _ordinal_inflect
        from wegorz_normalizer.inflect_pl import hour_ordinal as _hour_ordinal
        from wegorz_normalizer.unit_registry import REGISTRY as _REGISTRY
    except ImportError:
        from inflect_pl import cardinal_inflect as _cardinal_inflect
        from inflect_pl import ordinal_inflect as _ordinal_inflect
        from inflect_pl import hour_ordinal as _hour_ordinal

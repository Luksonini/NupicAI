...
const COPY = {
  pl: {
    ...
    kicker: 'Polskie studio AI do pracy z głosem', lead: 'Transkrypcja, tłumaczenie i naturalny dubbing w jednym miejscu.',
    support: 'Zamień audio lub wideo w gotową polską lub angielską wersję, zachowując rytm wypowiedzi i oryginalne tło.',
    start: 'Rozpocznij projekt', see: 'Zobacz jak działa', proof: ['40 wybranych głosów', 'Polski i angielski', 'Eksport WAV i MP4'],
    capabilities: [['Dokładna transkrypcja', 'TXT, SRT i VTT'], ['Tłumaczenie kontekstowe', 'Segment po segmencie'], ['Naturalne głosy', 'Tempo dopasowane do filmu'], ['Gotowy materiał', 'Miks audio i eksport MP4']],
    ...
    audienceLabel: 'Dla kogo', audienceTitle: 'Publikuj ten sam materiał dla nowej publiczności', audienceIntro: 'NupicAI łączy narzędzia, które zwykle wymagają kilku aplikacji i ręcznego przenoszenia plików.',
  ...
  en: {
    ...
    kicker: 'AI voice production studio', lead: 'Transcription, translation and natural dubbing in one workspace.',
    support: 'Turn audio or video into a polished Polish or English version while preserving pacing and the original background.',
    start: 'Start a project', see: 'See how it works', proof: ['40 curated voices', 'Polish and English', 'WAV and MP4 export'],
    capabilities: [['Accurate transcription', 'TXT, SRT and VTT'], ['Context-aware translation', 'Segment by segment'], ['Natural voices', 'Pacing matched to video'], ['Publish-ready media', 'Audio mix and MP4 export']],
    ...
    audienceLabel: 'Built for', audienceTitle: 'Publish the same story for a new audience', audienceIntro: 'NupicAI brings together tools that usually require several apps and manual file transfers.',

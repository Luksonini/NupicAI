...
```text
nupicai-update-20260905.bundle
...
cd /srv/nupicai
git status --short
git fetch /mnt/pendrive/nupicai-update-20260905.bundle master
...
git clone /mnt/pendrive/nupicai-update-20260905.bundle /tmp/nupicai-update
rsync -a \
  --exclude='.git/' \
  --exclude='.env' \
